...
const Nav = () => {
    ...
    const handleSubmit=(e)=>{
        e.preventDefault()
        axios.post('https://codetech-29i1.onrender.com/api/v1/applicationpath',{name,email,password,phone})
        .then((result)=>{
            console.log(result)
    ...
    const handleSubmit1=(e)=>{
        e.preventDefault()
        axios.post('https://codetech-29i1.onrender.com/api/v1/login',{email:email1,password:password1})
        .then((result)=>{
            console.log(result)
